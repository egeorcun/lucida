...
def test_known_model_names():
    assert set(MODEL_SPECS) == {
        ...
        "lucida-v5", "lucida-v6", "lucida-v7", "lucida-v8", "lucida-v9", "lucida-v10", "lucida-v11", "lucida-v11probe", "lucida-v12", "lucida-v13", "lucida-v14", "lucida-soup", "lucida-soup913", "lucida-soup91113",
        "inspyrenet", "lucida",
    }
